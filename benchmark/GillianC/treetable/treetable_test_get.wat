(module
  ...
  (func $tree_destroy (type 9) (param i32 i32)
    ...
    global.set $__stack_pointer
    return)
  (func $treetable_get (type 3) (param i32 i32 i32) (result i32)
