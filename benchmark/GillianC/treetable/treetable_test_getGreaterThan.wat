(module
  ...
  (func $tree_min (type 0) (param i32 i32) (result i32)
    ...
    local.get 17
    return)
  (func $treetable_get_greater_than (type 3) (param i32 i32 i32) (result i32)
