(module
  ...
  (func $tree_max (type 0) (param i32 i32) (result i32)
    ...
    local.get 17
    return)
  (func $treetable_get_lesser_than (type 3) (param i32 i32 i32) (result i32)
