(module
  ...
  (func $rotate_right (type 9) (param i32 i32)
    ...
    i32.store offset=12
    return)
  (func $remove_node (type 9) (param i32 i32)
    ...
    global.set $__stack_pointer
    return)
  (func $transplant (type 10) (param i32 i32 i32)
    ...
    i32.store offset=12
    return)
  (func $rebalance_after_delete (type 9) (param i32 i32)
  ...
  (func $dlmalloc (type 2) (param i32) (result i32)
    ...
    block  ;; label = @1
      ...
      block  ;; label = @2
        ...
        i32.const 0
        i64.const -1
        i64.store offset=4984 align=4
        i32.const 0
        i64.const 281474976776192
        i64.store offset=4976 align=4
        i32.const 0
        local.get 1
        i32.const 8
        i32.add
              ...
              block  ;; label = @6
                block  ;; label = @7
                  block  ;; label = @8
                    ...
                    i32.add
                    i32.const 0
                    i64.load offset=4956 align=4
                    i64.store align=4
                    local.get 8
                    i32.const 0
                    i64.load offset=4948 align=4
