(module
  ...
  (func $deque_get_buffer (type 1) (param i32) (result i32)
    ...
    local.get 5
    return)
  (func $deque_filter (type 3) (param i32 i32 i32) (result i32)
