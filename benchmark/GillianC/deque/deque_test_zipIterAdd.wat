(module
  ...
  (func $copy_buffer (type 9) (param i32 i32 i32)
    ...
    global.set $__stack_pointer
    return)
  (func $deque_add_at (type 3) (param i32 i32 i32) (result i32)
  ...
  (func $deque_zip_iter_next (type 3) (param i32 i32 i32) (result i32)
    ...
    local.get 113
    return)
  (func $deque_zip_iter_add (type 3) (param i32 i32 i32) (result i32)
