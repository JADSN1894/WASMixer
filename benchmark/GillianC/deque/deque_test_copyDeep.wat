(module
  ...
  (func $deque_destroy (type 2) (param i32)
    ...
    global.set $__stack_pointer
    return)
  (func $deque_destroy_cb (type 9) (param i32 i32)
    ...
    global.set $__stack_pointer
    return)
  (func $deque_remove_all_cb (type 9) (param i32 i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32)
    global.get $__stack_pointer
    local.set 2
    i32.const 16
    ...
    global.set $__stack_pointer
    return)
  (func $deque_foreach (type 9) (param i32 i32)
  ...
  (func $expand_capacity (type 1) (param i32) (result i32)
    ...
    local.get 47
    return)
  (func $copy_buffer (type 10) (param i32 i32 i32)
    ...
    global.set $__stack_pointer
    return)
  (func $deque_get_at (type 3) (param i32 i32 i32) (result i32)
    ...
    local.get 33
    return)
  (func $deque_copy_deep (type 3) (param i32 i32 i32) (result i32)
