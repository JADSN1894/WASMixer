(module
  ...
  (func $treeset_size (type 2) (param i32) (result i32)
    ...
    local.get 6
    return)
  (func $treeset_iter_init (type 9) (param i32 i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32)
    global.get $__stack_pointer
    local.set 2
    i32.const 16
