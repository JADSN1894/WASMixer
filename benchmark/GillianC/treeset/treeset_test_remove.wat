(module
  ...
  (func $treeset_add (type 0) (param i32 i32) (result i32)
    ...
    local.get 10
    return)
  (func $treeset_remove (type 3) (param i32 i32 i32) (result i32)
  ...
  (func $rotate_right (type 9) (param i32 i32)
    ...
    i32.store offset=12
    return)
  (func $treetable_remove (type 3) (param i32 i32 i32) (result i32)
