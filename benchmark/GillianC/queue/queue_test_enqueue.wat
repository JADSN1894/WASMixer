(module
  ...
  (func $queue_enqueue (type 0) (param i32 i32) (result i32)
    ...
    local.get 8
    return)
  (func $queue_size (type 2) (param i32) (result i32)
  ...
  (func $deque_get_last (type 0) (param i32 i32) (result i32)
    ...
    local.get 26
    return)
  (func $deque_size (type 2) (param i32) (result i32)
