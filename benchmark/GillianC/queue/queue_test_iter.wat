(module
  ...
  (func $queue_enqueue (type 0) (param i32 i32) (result i32)
    ...
    local.get 8
    return)
  (func $queue_iter_init (type 9) (param i32 i32)
  ...
  (func $copy_buffer (type 10) (param i32 i32 i32)
    ...
    global.set $__stack_pointer
    return)
  (func $deque_iter_init (type 9) (param i32 i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i32)
    global.get $__stack_pointer
    local.set 2
    i32.const 16
