(module
  ...
  (func $get_node_at (type 5) (param i32 i32 i32 i32) (result i32)
    ...
    local.get 40
    return)
  (func $slist_remove (type 2) (param i32 i32 i32) (result i32)
  ...
  (func $unlinkn (type 2) (param i32 i32 i32) (result i32)
    ...
    local.get 38
    return)
  (func $slist_get_at (type 2) (param i32 i32 i32) (result i32)
