(module
  ...
  (func $unlinkn (type 2) (param i32 i32 i32) (result i32)
    ...
    local.get 38
    return)
  (func $slist_remove_at (type 2) (param i32 i32 i32) (result i32)
