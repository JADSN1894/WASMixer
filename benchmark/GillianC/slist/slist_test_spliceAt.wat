(module
  ...
  (func $get_node_at (type 5) (param i32 i32 i32 i32) (result i32)
    ...
    local.get 40
    return)
  (func $slist_splice_at (type 2) (param i32 i32 i32) (result i32)
    ...
    local.get 36
    return)
  (func $splice_between (type 9) (param i32 i32 i32 i32)
