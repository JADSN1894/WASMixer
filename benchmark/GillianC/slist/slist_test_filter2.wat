(module
  ...
  (func $slist_filter (type 3) (param i32 i32 i32) (result i32)
    ...
    local.get 44
    return)
  (func $slist_iter_init (type 9) (param i32 i32)
