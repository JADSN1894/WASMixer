(module
  ...
  (func $link_all_externally (type 2) (param i32 i32 i32) (result i32)
    ...
    local.get 79
    return)
  (func $slist_add_all_at (type 2) (param i32 i32 i32) (result i32)
