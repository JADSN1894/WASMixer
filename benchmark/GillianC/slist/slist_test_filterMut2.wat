(module
  ...
  (func $slist_add_last (type 0) (param i32 i32) (result i32)
    ...
    local.get 36
    return)
  (func $unlinkn (type 3) (param i32 i32 i32) (result i32)
