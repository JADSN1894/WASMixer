(module
  ...
  (func $teardown_test (type 7)
    ...
    call $slist_destroy
    return)
  (func $CHECK_EQ_LIST (type 8) (param i32 i32)
  ...
  (func $slist_size (type 2) (param i32) (result i32)
    ...
    local.get 5
    return)
  (func $slist_filter (type 3) (param i32 i32 i32) (result i32)
  ...
  (func $slist_zip_iter_init (type 10) (param i32 i32 i32)
    ...
    i32.store offset=16
    return)
  (func $slist_zip_iter_next (type 3) (param i32 i32 i32) (result i32)
              ...
              block  ;; label = @6
                block  ;; label = @7
                  block  ;; label = @8
                    ...
                    i32.add
                    i32.const 0
                    i64.load offset=4944 align=4
                    i64.store align=4
                    local.get 8
                    i32.const 0
                    i64.load offset=4936 align=4
