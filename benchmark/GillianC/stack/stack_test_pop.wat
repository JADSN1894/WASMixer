(module
  ...
  (func $__original_main (type 8) (result i32)
    ...
    local.get 68
    return)
  (func $stack_conf_init (type 1) (param i32)
    ...
    global.set $__stack_pointer
    return)
  (func $stack_new (type 2) (param i32) (result i32)
  ...
  (func $stack_new_conf (type 0) (param i32 i32) (result i32)
    ...
    local.get 41
    return)
  (func $stack_destroy (type 1) (param i32)
  ...
  (func $stack_pop (type 0) (param i32 i32) (result i32)
    ...
    local.get 8
    return)
  (func $array_conf_init (type 1) (param i32)
  ...
  (func $array_new_conf (type 0) (param i32 i32) (result i32)
    ...
    local.get 76
    return)
  (func $array_destroy (type 1) (param i32)
