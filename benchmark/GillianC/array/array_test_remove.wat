(module
  ...
  (func $expand_capacity (type 1) (param i32) (result i32)
    ...
    local.get 68
    return)
  (func $array_remove (type 3) (param i32 i32 i32) (result i32)
