(module
  ...
  (func $scanf (type 0) (param i32 i32) (result i32)
    ...
    global.set $__stack_pointer
    local.get 1)
  (func $writev (type 4) (param i32 i32 i32) (result i32)
    (local i32 i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $__stdio_close (type 1) (param i32) (result i32)
    ...
    i32.load offset=56
    call $close)
  (func $readv (type 4) (param i32 i32 i32) (result i32)
    (local i32 i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $__towrite (type 1) (param i32) (result i32)
    ...
    i32.store offset=16
    i32.const 0)
  (func $__fwritex (type 4) (param i32 i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32)
    block  ;; label = @1
      block  ;; label = @2
        local.get 2
  ...
  (func $vscanf (type 0) (param i32 i32) (result i32)
    ...
    local.get 1
    call $vfscanf)
  (func $fprintf (type 4) (param i32 i32 i32) (result i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $wctomb (type 0) (param i32 i32) (result i32)
    ...
    i32.const 0
    call $wcrtomb)
  (func $wcrtomb (type 4) (param i32 i32 i32) (result i32)
    (local i32)
    i32.const 1
    local.set 3
    block  ;; label = @1
