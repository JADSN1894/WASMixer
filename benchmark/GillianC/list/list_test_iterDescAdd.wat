(module
  ...
  (func $get_node_at (type 2) (param i32 i32 i32) (result i32)
    ...
    local.get 69
    return)
  (func $link_behind (type 9) (param i32 i32)
  ...
  (func $list_size (type 4) (param i32) (result i32)
    ...
    local.get 5
    return)
  (func $list_diter_init (type 9) (param i32 i32)
