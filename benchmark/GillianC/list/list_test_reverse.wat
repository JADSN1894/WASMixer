(module
  ...
  (func $list_reverse (type 1) (param i32)
    ...
    global.set $__stack_pointer
    return)
  (func $swap (type 9) (param i32 i32)
    ...
    global.set $__stack_pointer
    return)
  (func $swap_adjacent (type 9) (param i32 i32)
