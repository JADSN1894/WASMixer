(module
  ...
  (func $unlinkn (type 0) (param i32 i32) (result i32)
    ...
    local.get 60
    return)
  (func $list_sort_in_place (type 9) (param i32 i32)
    ...
    global.set $__stack_pointer
    return)
  (func $split (type 5) (param i32 i32 i32 i32) (result i32)
    ...
    local.get 63
    return)
  (func $merge (type 10) (param i32 i32 i32 i32 i32)
              ...
              block  ;; label = @6
                block  ;; label = @7
                  block  ;; label = @8
                    ...
                    i32.add
                    i32.const 0
                    i64.load offset=4768 align=4
                    i64.store align=4
                    local.get 8
                    i32.const 0
                    i64.load offset=4760 align=4
  ...
  (func $pad (type 10) (param i32 i32 i32 i32 i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 256
    i32.sub
