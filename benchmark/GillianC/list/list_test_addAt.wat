(module
  ...
  (func $list_add_last (type 0) (param i32 i32) (result i32)
    ...
    local.get 39
    return)
  (func $list_add_at (type 2) (param i32 i32 i32) (result i32)
