(module
  ...
  (func $list_get_at (type 3) (param i32 i32 i32) (result i32)
    ...
    local.get 16
    return)
  (func $list_copy_deep (type 3) (param i32 i32 i32) (result i32)
