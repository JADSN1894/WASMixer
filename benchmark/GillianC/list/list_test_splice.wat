(module
  ...
  (func $list_splice (type 0) (param i32 i32) (result i32)
    ...
    local.get 9
    return)
  (func $list_splice_at (type 2) (param i32 i32 i32) (result i32)
    ...
    local.get 64
    return)
  (func $splice_between (type 10) (param i32 i32 i32 i32)
