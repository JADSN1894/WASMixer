(module
  ...
  (func $list_get_at (type 2) (param i32 i32 i32) (result i32)
    ...
    local.get 16
    return)
  (func $list_sublist (type 5) (param i32 i32 i32 i32) (result i32)
