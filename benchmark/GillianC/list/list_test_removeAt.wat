(module
  ...
  (func $unlinkn (type 0) (param i32 i32) (result i32)
    ...
    local.get 60
    return)
  (func $list_remove_at (type 2) (param i32 i32 i32) (result i32)
