(module
  ...
  (func $list_size (type 4) (param i32) (result i32)
    ...
    local.get 5
    return)
  (func $list_iter_init (type 9) (param i32 i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32)
    global.get $__stack_pointer
    local.set 2
    i32.const 16
  ...
  (func $list_iter_add (type 0) (param i32 i32) (result i32)
    ...
    local.get 47
    return)
  (func $link_after (type 9) (param i32 i32)
              ...
              block  ;; label = @6
                block  ;; label = @7
                  block  ;; label = @8
                    ...
                    i32.add
                    i32.const 0
                    i64.load offset=4912 align=4
                    i64.store align=4
                    local.get 8
                    i32.const 0
                    i64.load offset=4904 align=4
