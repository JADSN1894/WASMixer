(module
  ...
  (func $unlinkn (type 0) (param i32 i32) (result i32)
    ...
    local.get 60
    return)
  (func $list_replace_at (type 5) (param i32 i32 i32 i32) (result i32)
