(module
  ...
  (func $list_index_of (type 5) (param i32 i32 i32 i32) (result i32)
    ...
    local.get 31
    return)
  (func $list_zip_iter_init (type 9) (param i32 i32 i32)
  ...
  (func $list_zip_iter_next (type 2) (param i32 i32 i32) (result i32)
    ...
    local.get 52
    return)
  (func $list_zip_iter_replace (type 10) (param i32 i32 i32 i32 i32) (result i32)
