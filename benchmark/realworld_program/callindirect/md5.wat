(module
  ...
  (func $_start.command_export (type 7)
    ...
    i32.const 53
    call_indirect (type 7))
  (table (;0;) 67 72 funcref)
  (memory (;0;) 2)
  (global $__stack_pointer (mut i32) (i32.const 71328))
  (export "memory" (memory 0))
  (export "_start" (func $_start.command_export))
  (elem (;0;) (i32.const 1) func $__stdio_write $__stdio_close $__stdout_write $__stdio_seek $to_bytes $abort $__lctrans $__lseek $pop_arg $memcpy $pad $_start $puts $__ofl_lock $__wasi_fd_fdstat_get $sbrk $close $strnlen $main $exit $malloc $memset $__stdio_exit $__imported_wasi_snapshot_preview1_args_sizes_get $__towrite $memchr $__fwritex $__imported_wasi_snapshot_preview1_fd_seek $__wasi_fd_close $long_double_not_supported $dlfree $__imported_wasi_snapshot_preview1_fd_fdstat_get $md5 $__imported_wasi_snapshot_preview1_proc_exit $__overflow $__main_void $wcrtomb $__wasi_args_get $writev $printf $fputs $_start.command_export $dlmalloc $_Exit $strlen $wctomb $strerror $__imported_wasi_snapshot_preview1_fd_write $to_int32 $__wasi_proc_exit $__isatty $frexp $__wasm_call_dtors $__original_main $dummy $calloc $dummy.1 $printf_core $fwrite $__imported_wasi_snapshot_preview1_args_get $vfprintf $free $__wasi_fd_write $__imported_wasi_snapshot_preview1_fd_close $__wasi_fd_seek $__wasi_args_sizes_get)
