(module
  ...
  (import "wasi_snapshot_preview1" "args_get" (func $xskncyzf (type 2)))
  (import "wasi_snapshot_preview1" "args_sizes_get" (func $avwldycf (type 2)))
  (import "wasi_snapshot_preview1" "fd_close" (func $szliftck (type 3)))
  (import "wasi_snapshot_preview1" "fd_fdstat_get" (func $bdzpyftc (type 2)))
  (import "wasi_snapshot_preview1" "fd_seek" (func $txmvyjlf (type 4)))
  (import "wasi_snapshot_preview1" "fd_write" (func $exdnjlof (type 5)))
  (import "wasi_snapshot_preview1" "proc_exit" (func $dgapkfyt (type 6)))
  (func $ojvrslex (type 7)
    (local i32)
    block  ;; label = @1
      call $kcvtqgfs
      local.tee 0
  ...
  (func $icobutdv (type 8) (param i32 i32)
    ...
    i32.store8 offset=3
    return)
  (func $jafncvgd (type 3) (param i32) (result i32)
    ...
    local.get 28
    return)
  (func $libuohja (type 9) (param i32 i32 i32)
    ...
    global.set $fygremzt
    return)
  (func $nijkecwv (type 2) (param i32 i32) (result i32)
    ...
    local.get 50
    return)
  (func $ncjoxzbu (type 3) (param i32) (result i32)
    local.get 0
    call $dazhvfwg)
  (func $dazhvfwg (type 3) (param i32) (result i32)
    ...
    global.set $fygremzt
    local.get 3)
  (func $xcvhbumj (type 6) (param i32)
    local.get 0
    call $aofqgusm)
  (func $aofqgusm (type 6) (param i32)
  ...
  (func $zduathno (type 2) (param i32 i32) (result i32)
    (local i32 i64)
    block  ;; label = @1
      block  ;; label = @2
        local.get 0
    ...
    local.get 0)
  (func $qmxajyih (type 7)
    unreachable
    unreachable)
  (func $rilfmnca (type 3) (param i32) (result i32)
    block  ;; label = @1
      local.get 0
      br_if 0 (;@1;)
      memory.size
    ...
    call $qmxajyih
    unreachable)
  (func $muqzjbpa (type 6) (param i32)
    local.get 0
    call $pvasbiqy
    unreachable)
  (func $imcxpate (type 10) (result i32)
    ...
    call $muqzjbpa
    unreachable)
  (func $kcvtqgfs (type 10) (result i32)
    call $imcxpate)
  (func $cuofvbal (type 2) (param i32 i32) (result i32)
    local.get 0
    local.get 1
    call $xskncyzf
    i32.const 65535
    i32.and)
  (func $zycsjdpl (type 2) (param i32 i32) (result i32)
    local.get 0
    local.get 1
    call $avwldycf
    i32.const 65535
    i32.and)
  (func $xqgmzviy (type 3) (param i32) (result i32)
    local.get 0
    call $szliftck
    i32.const 65535
    i32.and)
  (func $lbtdnoky (type 2) (param i32 i32) (result i32)
    local.get 0
    local.get 1
    call $bdzpyftc
    i32.const 65535
    i32.and)
  (func $fdtoneyh (type 4) (param i32 i64 i32 i32) (result i32)
    local.get 0
    local.get 1
    local.get 2
    local.get 3
    ...
    i32.const 65535
    i32.and)
  (func $lxzakobg (type 5) (param i32 i32 i32 i32) (result i32)
    local.get 0
    local.get 1
    local.get 2
    local.get 3
    ...
    i32.const 65535
    i32.and)
  (func $pvasbiqy (type 6) (param i32)
    local.get 0
    call $dgapkfyt
    unreachable)
  (func $quobsejl (type 7))
  (func $gijblkzq (type 7)
    call $quobsejl
    call $ycvuriwm)
  (func $olymrqcz (type 6) (param i32)
    call $quobsejl
    call $ycvuriwm
    local.get 0
    call $muqzjbpa
    unreachable)
  (func $tazixpjb (type 0) (param i32 i32 i32) (result i32)
    (local i32 i32)
    global.get $fygremzt
    i32.const 16
    i32.sub
    ...
    global.set $fygremzt
    local.get 4)
  (func $kicfyzqs (type 0) (param i32 i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32)
    global.get $fygremzt
    i32.const 16
    i32.sub
    ...
    global.set $fygremzt
    local.get 6)
  (func $ytazhbvg (type 3) (param i32) (result i32)
    (local i32 i32)
    global.get $fygremzt
    i32.const 32
    i32.sub
    ...
    global.set $fygremzt
    local.get 2)
  (func $nulcvqza (type 0) (param i32 i32 i32) (result i32)
    local.get 0
    i32.const 1
    i32.store offset=32
    block  ;; label = @1
    ...
    local.get 2
    call $kicfyzqs)
  (func $fkqvyeos (type 3) (param i32) (result i32)
    (local i32)
    local.get 0
    local.get 0
    i32.load offset=60
    ...
    i32.store offset=16
    i32.const 0)
  (func $rvibuljh (type 0) (param i32 i32 i32) (result i32)
    ...
    local.get 4)
  (func $lvgkwnuz (type 5) (param i32 i32 i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32)
    local.get 2
    local.get 1
    i32.mul
    ...
    local.get 1
    i32.div_u)
  (func $qmbazfds (type 2) (param i32 i32) (result i32)
    (local i32)
    local.get 0
    call $egizcstq
    local.set 2
    ...
    i32.ne
    select)
  (func $bcutnwmp (type 3) (param i32) (result i32)
    block  ;; label = @1
      local.get 0
      i32.const 3952
      call $qmbazfds
    ...
    i32.const 31
    i32.shr_s)
  (func $iabofznk (type 1) (param i32 i64 i32) (result i64)
    (local i32)
    global.get $fygremzt
    i32.const 16
    i32.sub
    ...
    global.set $fygremzt
    local.get 1)
  (func $fhdepazw (type 1) (param i32 i64 i32) (result i64)
    local.get 0
    i32.load offset=56
    local.get 1
    local.get 2
    call $iabofznk)
  (func $iorqmzjf (type 3) (param i32) (result i32)
    block  ;; label = @1
      local.get 0
      call $xqgmzviy
      local.tee 0
    ...
    i32.store offset=4688
    i32.const -1)
  (func $vwnxryig (type 3) (param i32) (result i32)
    local.get 0
    i32.load offset=56
    call $iorqmzjf)
  (func $lxwesibt (type 2) (param i32 i32) (result i32)
    (local i32 i32 i32)
    global.get $fygremzt
    i32.const 16
    i32.sub
    ...
    global.set $fygremzt
    local.get 3)
  (func $lmisrgtu (type 3) (param i32) (result i32)
    (local i32)
    block  ;; label = @1
      i32.const 0
    ...
    i32.load offset=20
    call $lpigtnxo)
  (func $jmqvzxad (type 0) (param i32 i32 i32) (result i32)
    (local i32 i32 i32)
    global.get $fygremzt
    i32.const 208
    i32.sub
    ...
    global.set $fygremzt
    local.get 0)
  (func $jfvnytdz (type 11) (param i32 i32 i32 i32 i32) (result i32)
    ...
    global.set $fygremzt
    local.get 15)
  (func $sawfrupj (type 9) (param i32 i32 i32)
    block  ;; label = @1
      block  ;; label = @2
        block  ;; label = @3
          block  ;; label = @4
  ...
  (func $ewxcpfhz (type 12) (param i32 i32 i32 i32 i32)
    (local i32)
    global.get $fygremzt
    i32.const 256
    i32.sub
  ...
  (func $zyjixgch (type 7)
    ...
    call $qmxajyih
    unreachable)
  (func $odzfkbmx (type 2) (param i32 i32) (result i32)
    (local i32)
    global.get $fygremzt
    i32.const 16
    i32.sub
    ...
    global.set $fygremzt
    local.get 1)
  (func $bfvizaur (type 10) (result i32)
    i32.const 5772)
  (func $ycvuriwm (type 7)
    (local i32 i32 i32)
    block  ;; label = @1
      call $bfvizaur
      i32.load
  ...
  (func $irhwoysc (type 0) (param i32 i32 i32) (result i32)
    ...
    local.get 0)
  (func $voqupact (type 2) (param i32 i32) (result i32)
    (local i32)
    local.get 0
    i32.const 0
    local.get 1
    ...
    local.get 2
    select)
  (func $ntpuhvql (type 0) (param i32 i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32)
    block  ;; label = @1
      block  ;; label = @2
        local.get 1
    ...
    local.get 0)
  (func $egizcstq (type 3) (param i32) (result i32)
    (local i32 i32)
    local.get 0
    local.set 1
    block  ;; label = @1
    ...
    local.get 0
    i32.sub)
  (func $zojglsmn (type 0) (param i32 i32 i32) (result i32)
    (local i32 i32 i32)
    local.get 2
    i32.const 0
    i32.ne
    ...
    i32.const 0)
  (func $uogqktjr (type 2) (param i32 i32) (result i32)
    local.get 0)
  (func $lpigtnxo (type 2) (param i32 i32) (result i32)
    local.get 0
    local.get 1
    call $uogqktjr)
  (func $hdnolzub (type 0) (param i32 i32 i32) (result i32)
    (local i32)
    i32.const 1
    local.set 3
    block  ;; label = @1
    ...
    local.get 3)
  (func $gjqvcule (type 2) (param i32 i32) (result i32)
    block  ;; label = @1
      local.get 0
      br_if 0 (;@1;)
      i32.const 0
    ...
    i32.const 0
    call $hdnolzub)
  (func $zkctdarl (type 13) (param f64 i32) (result f64)
    (local i64 i32)
    block  ;; label = @1
      local.get 0
      i64.reinterpret_f64
