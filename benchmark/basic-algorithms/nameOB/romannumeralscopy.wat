(module
  ...
  (import "wasi_snapshot_preview1" "args_get" (func $wlfqnjhm (type 2)))
  (import "wasi_snapshot_preview1" "args_sizes_get" (func $onqtjvkc (type 2)))
  (import "wasi_snapshot_preview1" "fd_close" (func $lyosmqth (type 3)))
  (import "wasi_snapshot_preview1" "fd_fdstat_get" (func $lixpvjgc (type 2)))
  (import "wasi_snapshot_preview1" "fd_seek" (func $oqyvndix (type 4)))
  (import "wasi_snapshot_preview1" "fd_write" (func $xivrhpso (type 5)))
  (import "wasi_snapshot_preview1" "proc_exit" (func $cizamypr (type 6)))
  (func $gwrfjsya (type 7))
  (func $hsfbvtoc (type 7)
    (local i32)
    block  ;; label = @1
      block  ;; label = @2
        i32.const 0
    ...
    call $jdrcpalx
    unreachable)
  (func $gynjzxlw (type 2) (param i32 i32) (result i32)
    ...
    local.get 309
    return)
  (func $jgnibavs (type 8) (param i32 i32)
    ...
    return)
  (func $dtzqbvmx (type 8) (param i32 i32)
    ...
    i32.store8 offset=3712
    return)
  (func $oyruebfg (type 3) (param i32) (result i32)
    local.get 0
    call $tblodfjs)
  (func $tblodfjs (type 3) (param i32) (result i32)
    ...
    global.set $xkocrvld
    local.get 4)
  (func $wvgchxpn (type 6) (param i32)
    local.get 0
    call $tgikwboy)
  (func $tgikwboy (type 6) (param i32)
  ...
  (func $rixhlvba (type 2) (param i32 i32) (result i32)
    (local i32 i64)
    block  ;; label = @1
      block  ;; label = @2
        local.get 0
    ...
    local.get 0)
  (func $wgpmqnvh (type 6) (param i32)
    local.get 0
    call $jdrcpalx
    unreachable)
  (func $jbcsgyhx (type 9) (result i32)
    (local i32 i32 i32)
    global.get $xkocrvld
    i32.const 16
    i32.sub
    ...
    call $wgpmqnvh
    unreachable)
  (func $obskhgzi (type 2) (param i32 i32) (result i32)
    local.get 0
    local.get 1
    call $wlfqnjhm
    i32.const 65535
    i32.and)
  (func $lcvkwfha (type 2) (param i32 i32) (result i32)
    local.get 0
    local.get 1
    call $onqtjvkc
    i32.const 65535
    i32.and)
  (func $pfjedbim (type 3) (param i32) (result i32)
    local.get 0
    call $lyosmqth
    i32.const 65535
    i32.and)
  (func $pyriejbc (type 2) (param i32 i32) (result i32)
    local.get 0
    local.get 1
    call $lixpvjgc
    i32.const 65535
    i32.and)
  (func $najqfplk (type 4) (param i32 i64 i32 i32) (result i32)
    local.get 0
    local.get 1
    local.get 2
    local.get 3
    ...
    i32.const 65535
    i32.and)
  (func $xbugvhlp (type 5) (param i32 i32 i32 i32) (result i32)
    local.get 0
    local.get 1
    local.get 2
    local.get 3
    ...
    i32.const 65535
    i32.and)
  (func $jdrcpalx (type 6) (param i32)
    local.get 0
    call $cizamypr
    unreachable)
  (func $iwpcjkgv (type 7)
    unreachable
    unreachable)
  (func $iptmebwk (type 3) (param i32) (result i32)
    block  ;; label = @1
      local.get 0
      br_if 0 (;@1;)
      memory.size
    ...
    call $iwpcjkgv
    unreachable)
  (func $xledmrgo (type 7))
  (func $vnjtohry (type 7)
    call $xledmrgo
    call $byeuvcmt)
  (func $myokbxrl (type 2) (param i32 i32) (result i32)
    (local i32)
    global.get $xkocrvld
    i32.const 16
    i32.sub
    ...
    global.set $xkocrvld
    local.get 1)
  (func $wzxbyomp (type 3) (param i32) (result i32)
    block  ;; label = @1
      local.get 0
      call $pfjedbim
      local.tee 0
    ...
    i32.store offset=4712
    i32.const -1)
  (func $xryqmcho (type 3) (param i32) (result i32)
    local.get 0
    i32.load offset=56
    call $wzxbyomp)
  (func $klpdyriu (type 0) (param i32 i32 i32) (result i32)
    (local i32 i32)
    global.get $xkocrvld
    i32.const 16
    i32.sub
    ...
    global.set $xkocrvld
    local.get 4)
  (func $mutavylh (type 0) (param i32 i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32)
    global.get $xkocrvld
    i32.const 16
    i32.sub
    ...
    global.set $xkocrvld
    local.get 1)
  (func $ukxocpqv (type 3) (param i32) (result i32)
    (local i32 i32)
    global.get $xkocrvld
    i32.const 32
    i32.sub
    ...
    global.set $xkocrvld
    local.get 2)
  (func $jxispheq (type 0) (param i32 i32 i32) (result i32)
    local.get 0
    i32.const 1
    i32.store offset=32
    block  ;; label = @1
    ...
    local.get 2
    call $mutavylh)
  (func $bojavpyc (type 1) (param i32 i64 i32) (result i64)
    (local i32)
    global.get $xkocrvld
    i32.const 16
    i32.sub
    ...
    global.set $xkocrvld
    local.get 1)
  (func $kdfzucrv (type 1) (param i32 i64 i32) (result i64)
    local.get 0
    i32.load offset=56
    local.get 1
    local.get 2
    call $bojavpyc)
  (func $pkyqucor (type 9) (result i32)
    i32.const 6248)
  (func $byeuvcmt (type 7)
    (local i32 i32 i32)
    block  ;; label = @1
      call $pkyqucor
      i32.load
  ...
  (func $ytjdrfsz (type 3) (param i32) (result i32)
    (local i32)
    local.get 0
    local.get 0
    i32.load offset=60
    ...
    i32.store offset=16
    i32.const 0)
  (func $ydwhkbil (type 0) (param i32 i32 i32) (result i32)
    ...
    local.get 4)
  (func $vsnrptgf (type 5) (param i32 i32 i32 i32) (result i32)
    ...
    local.get 1
    i32.div_u)
  (func $dapfsmnu (type 2) (param i32 i32) (result i32)
    local.get 0)
  (func $ajkyhupc (type 2) (param i32 i32) (result i32)
    local.get 0
    local.get 1
    call $dapfsmnu)
  (func $utafcvhw (type 3) (param i32) (result i32)
    (local i32)
    block  ;; label = @1
      i32.const 0
    ...
    i32.load offset=20
    call $ajkyhupc)
  (func $dzuxgyro (type 0) (param i32 i32 i32) (result i32)
    (local i32)
    i32.const 1
    local.set 3
    block  ;; label = @1
    ...
    local.get 3)
  (func $grxpldna (type 2) (param i32 i32) (result i32)
    block  ;; label = @1
      local.get 0
      br_if 0 (;@1;)
      i32.const 0
    ...
    i32.const 0
    call $dzuxgyro)
  (func $ltxyudjs (type 10) (param f64 i32) (result f64)
    (local i64 i32)
    block  ;; label = @1
      local.get 0
      i64.reinterpret_f64
    ...
    local.get 0)
  (func $gtvhnfmz (type 2) (param i32 i32) (result i32)
    (local i32)
    local.get 0
    call $zirauhgj
    local.set 2
    ...
    i32.ne
    select)
  (func $mdniwpbz (type 0) (param i32 i32 i32) (result i32)
    (local i32 i32 i32)
    global.get $xkocrvld
    i32.const 208
    i32.sub
    ...
    global.set $xkocrvld
    local.get 0)
  (func $dprhusjn (type 11) (param i32 i32 i32 i32 i32) (result i32)
    ...
    global.set $xkocrvld
    local.get 18)
  (func $ucswdjox (type 12) (param i32 i32 i32)
    block  ;; label = @1
      block  ;; label = @2
        block  ;; label = @3
          block  ;; label = @4
  ...
  (func $yabunjpk (type 13) (param i32 i32 i32 i32 i32)
    (local i32)
    global.get $xkocrvld
    i32.const 256
    i32.sub
  ...
  (func $aexpsbkf (type 7)
    ...
    call $iwpcjkgv
    unreachable)
  (func $jbatqdne (type 0) (param i32 i32 i32) (result i32)
    ...
    local.get 0)
  (func $naezlich (type 0) (param i32 i32 i32) (result i32)
    ...
    local.get 0)
  (func $zirauhgj (type 3) (param i32) (result i32)
    (local i32 i32)
    local.get 0
    local.set 1
    block  ;; label = @1
    ...
    local.get 0
    i32.sub)
  (func $gfevcxua (type 0) (param i32 i32 i32) (result i32)
    (local i32 i32 i32)
    local.get 2
    i32.const 0
    i32.ne
    ...
    i32.const 0)
  (func $qkvxwutz (type 2) (param i32 i32) (result i32)
    (local i32)
    local.get 0
    i32.const 0
    local.get 1
