(module
  ...
  (export "_ADvfffCkMnp_create" (func 46))
  (export "_ADvfffCkMnp_destroy" (func 45))
  (export "_ADvfffCkMnp_hash" (func 44))
  ...
  (data (;22;) (i32.const 12232) "ADvfffCkMnp variant 1 needs at least 43 bytes of data\00\01\02\04\08\10 @\80\1b6%s\0a\00Bad keccak use\00-+   0X0x\00-0X+0X 0X-0x+0x 0x\00inf\00INF\00NAN\00nan\00(null)\00."))
